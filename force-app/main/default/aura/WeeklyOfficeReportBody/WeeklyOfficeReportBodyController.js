({
    ...
    selectDate : function(component, event, helper){
        ...
        component.set("v.oDate", reportDate);
        component.set("v.tab", "office");

        var evt = component.getEvent('WeeklyOfficeReportEvent');
        evt.setParam('WeeklyOfficeReportDate',reportDate);
        evt.setParam('Tab','office');
        evt.fire();
    ...
    clickFullScreen : function(component, event, helper){
        var msg = $A.get('$Label.c.WEEKLY_OFFICE_REPORT_FULLSCREEN');
